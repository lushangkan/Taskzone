<template>
  <div class="fixed bottom-8 right-8 flex flex-col justify-end items-end gap-[20px]">
    ...
    <Transition name="add-task-btn">
      <button v-show="appStore.addTaskBtnShow" type="button" title="add task" @click="optionsBtnShow=!optionsBtnShow"
