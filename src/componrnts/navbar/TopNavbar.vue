<template>
  ...
  <sticky-element :scrollElement="scrollEle" stuckClass="navbar-stuck" showClass="navbar-show" transitionClass="navbar-transition" id="sticky-navbar">
    <div id="app-navbar" class="fixed flex flex-col justify-start items-center w-full py-[16px] z-10">
      <ion-header
          class="d-navbar border-none w-[348px] h-[63px] px-[13px] rounded-3xl navbar-shadow bg-gradient-to-br from-[hsl(var(--p--100))] to-[hsl(var(--p-300))]">
        <div v-if="!multiSelectMode" class="w-full h-full flex flex-row justify-around items-center px-0">
